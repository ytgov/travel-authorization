...
This directory contains AI workflows and agent-specific configurations for the Travel Authorization (TravelAuth) system.
...
to create admin UI for the TravelAuthorization model.
```
...
4. **Reference Implementations**
   ...
   - Example: `Reference: TravelAuthorization (commit: <commit-hash>)`
...
claude "Follow agents/workflows/create-admin-ui.md to create admin UI for TravelAuthorization model"

# Or with hardlink in place
claude "Use the create-admin-ui workflow for TravelAuthorization model"
```
...
Create admin UI for TravelAuthorization model
```

### Using with Cursor

```
Use .cursor/workflows/create-admin-ui.md to implement admin UI for TravelAuthorization model
```
